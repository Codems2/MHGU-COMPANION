...
export const heavyBowgunBuilds = [
  {
    ...
    weapon: {
      ...
      treeNote:
        'Cadena REAL de la herrería (datos de Kiranico): se mejora una ballesta genérica (Arbalest) hasta la Ballesta Pesada de Tigrex. Nombres de arma final y materiales reales; cantidades por mejora orientativas.',
      tree: [
        { name: 'Ballesta', nameEn: 'Arbalest', rank: 'LR', attack: 120, note: 'Ballesta pesada genérica de la herrería: el punto de partida REAL de esta rama.', materials: [{ id: 'iron-ore', qty: 6 }, { id: 'monster-bone-m', qty: 2 }] },
        { name: 'Aullido de Tigrex', nameEn: 'Tigrex Howl', rank: 'G', attack: 312, note: 'Ballesta final de Tigrex. Necesita romper la cabeza (colmillos) y el Mantón de Tigrex (raro).', materials: [{ id: 'tigrex-scale-plus', qty: 3 }, { id: 'tigrex-carapace', qty: 5 }, { id: 'tigrex-hardfang', qty: 3 }, { id: 'tigrex-cortex', qty: 4 }, { id: 'tigrex-mantle', qty: 1 }, { id: 'true-armor-sphere', qty: 2 }] },
      ],
    },
    armor: {
      note:
    ...
    progression: [
      {
        ...
        gear: [
          { type: 'Arma', name: 'Ballesta básica (Arbalest)', skills: null, note: 'Ballesta pesada genérica (Arbalest), el punto de partida real.' },
          { type: 'Armadura', name: 'Set Hueso / Aleación LR', skills: 'Ataque, Recarga parcial', note: 'Barato; te enseña a gestionar munición.' },
        ],
        objectives: ['Forja una ballesta genérica (Arbalest).', 'Reúne un set LR cómodo.', 'Practica Perforación y la distancia crítica en monstruos grandes (Bulldrome, Lagombi).'],
      ...
      {
        phase: 2, rank: 'Rango Bajo · final', title: 'Mejora la ballesta básica y salto a HR',
        body: 'Sigue mejorando la ballesta genérica (Arbalest) para cerrar el Rango Bajo con Perforación de sobra. Supera la urgente que abre Rango Alto.',
        gear: [
          { type: 'Arma', name: 'Ballesta genérica mejorada', skills: null, note: 'Mejora la ballesta genérica; Perforación Lv1 abundante.' },
          { type: 'Armadura', name: 'Set LR con Recarga/Ataque', skills: 'Recarga rápida, Ataque', note: 'Apunta al manejo de munición.' },
        ],
        objectives: ['Mejora la ballesta genérica (Arbalest).', 'Completa la urgente para subir a Rango Alto.'],
        materialsFocus: ['machalite-ore', 'iron-ore', 'monster-bone-m'],
      },
      {
        phase: 3, rank: 'Rango Alto · inicio', title: 'Caza Tigrex y empieza la rama de Tigrex',
        body:
        ...
        gear: [
          { type: 'Arma', name: 'Ballesta de Tigrex (rama)', skills: null, note: 'Empieza a mejorar la rama de Tigrex con materiales de HR.' },
        ...
        objectives: ['Caza Tigrex varias veces; rompe la espalda.', 'Empieza a forjar la Ballesta de Tigrex.', 'Monta munición Perforante Lv2 y Normal Lv2.'],
      ...
      },
      {
        ...
        body: 'Antes de saltar a rango G, caza Rathalos en HR para empezar el Punto Débil y reúne piezas HR de Tigrex. Sigues mejorando la rama de Tigrex.',
        gear: [
          { type: 'Arma', name: 'Ballesta de Tigrex (puente)', skills: null, note: 'Aguanta hasta el arma final de rango G.' },
      ...
      },
      {
        ...
        gear: [
          { type: 'Arma', name: 'Ballesta de Tigrex (puente a rango G)', skills: null, note: 'Te sirve hasta reunir los materiales del arma final.' },
...

  {
    ...
    weapon: {
      ...
      treeNote:
        'Cadena REAL de la herrería (datos de Kiranico): se mejora una ballesta genérica (Arbalest) hasta la Ballesta Pesada de Zinogre. Nombres de arma final y materiales reales; cantidades por mejora orientativas.',
      tree: [
        { name: 'Ballesta', nameEn: 'Arbalest', rank: 'LR', attack: 120, note: 'Ballesta pesada genérica de la herrería: el punto de partida REAL de esta rama.', materials: [{ id: 'iron-ore', qty: 6 }, { id: 'monster-bone-m', qty: 2 }] },
        { name: 'Temblor del Usurpador', nameEn: "Usurper's Tremor", rank: 'G', attack: 312, note: 'Ballesta final de Zinogre. Necesita la Esmeralda celeste de Zinogre (rara).', materials: [{ id: 'zinogre-shell', qty: 4 }, { id: 'zinogre-carapace', qty: 4 }, { id: 'zinogre-hardhorn', qty: 4 }, { id: 'zinogre-cortex', qty: 5 }, { id: 'zinogre-skymerald', qty: 1 }, { id: 'true-armor-sphere', qty: 2 }] },
      ],
    },
    armor: {
      note:
    ...
    progression: [
      {
        ...
        objectives: ['Forja una ballesta genérica (Arbalest).', 'Reúne un set LR cómodo.', 'Practica Normal a la distancia crítica.'],
        materialsFocus: ['iron-ore', 'monster-bone-m'],
      },
      {
        phase: 2, rank: 'Rango Bajo · final', title: 'Mejora la ballesta básica y salto a HR',
        body: 'Sigue mejorando la ballesta genérica (Arbalest) para cerrar el Rango Bajo con Normal Lv2 abundante. Supera la urgente que abre Rango Alto.',
        gear: [
          { type: 'Arma', name: 'Ballesta genérica mejorada', skills: null, note: 'Mejora la ballesta genérica; Normal Lv2 abundante.' },
          { type: 'Armadura', name: 'Set LR con Recarga/Ataque', skills: 'Recarga rápida, Ataque', note: 'Apunta al manejo de munición.' },
        ],
        objectives: ['Mejora la ballesta genérica (Arbalest).', 'Completa la urgente para subir a Rango Alto.'],
        materialsFocus: ['machalite-ore', 'iron-ore', 'monster-bone-m'],
      ...
      {
        phase: 3, rank: 'Rango Alto · inicio', title: 'Caza Zinogre y empieza la rama de Zinogre',
        body:
        ...
        gear: [
          { type: 'Arma', name: 'Ballesta de Zinogre (rama Usurper)', skills: null, note: 'Empieza a mejorar la rama de Zinogre con materiales de HR.' },
          { type: 'Armadura', name: 'Set HR de transición', skills: 'Recarga rápida, Retroceso reducido', note: 'Comodidad de manejo mientras farmeas.' },
        ],
        objectives: ['Caza Zinogre; rompe cuernos y espalda.', 'Empieza a forjar la Ballesta de Zinogre.', 'Monta munición Normal Lv2 y Trueno.'],
      ...
      },
      {
        ...
        body: 'Caza Rathalos en HR para empezar el Punto Débil y reúne piezas HR de Zinogre. Sigues mejorando la rama de Zinogre hasta el rango G.',
        gear: [
          { type: 'Arma', name: 'Ballesta de Zinogre (puente)', skills: null, note: 'Aguanta hasta el arma final de rango G.' },
      ...
      },
      {
        ...
        body: 'Combina piezas de Zinogre (Vista Crítica, manejo) con Rathalos (Punto Débil) y la faja de Tigrex (Recarga). Captura a Rathalos para los materiales raros. Sigues mejorando la rama de Zinogre.',
        gear: [
          { type: 'Arma', name: 'Ballesta de Zinogre (puente a rango G)', skills: null, note: 'Te sirve hasta reunir los materiales del arma final.' },
